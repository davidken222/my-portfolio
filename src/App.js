    ...
    <div>
      ...
      <div className="navbar">
        ...
        <div className="navbar-links">
          <a href="#home" onClick={() => document.querySelector(".navbar-links").classList.remove("active")}>Home</a>
          <a href="#about" onClick={() => document.querySelector(".navbar-links").classList.remove("active")}>About</a>
          <a href="#projects" onClick={() => document.querySelector(".navbar-links").classList.remove("active")}>Projects</a>
          <a href="#contact" onClick={() => document.querySelector(".navbar-links").classList.remove("active")}>Contact</a>
        </div>
      ...
      <section id="contact" className="section contact">
        ...
        <div className="ContactWrapper">
          <div className="ContactGrid">
            ...
            {/* Email */}
            <a href="mailto:davidawodi@outlook.com" className="ContactCard">
          ...
          {/* Tiny footer note */}
          <p className="contact-footer">All Rights Reserved ® David</p>
        </div>
      </section>
